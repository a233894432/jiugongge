...
(function(root, factory) {
    ...
    pictureCarousel.prototype = {
        init: function() {
            var l = this.options.imgUrl.length,
                Html = [],
                L = l;
        ...
        _start: function(e) {
            ...
            this.directionY = 0;
            this.moveStatu = false;
            if (e.type === "mousedown") { this.el.addEventListener("mousemove", this, false);
                this.el.addEventListener("mousecancle", this, false) }
        },
        _move: function(e) {
            var toucher = e.touches ? e.touches[0] : e,
                l = this.options.imgUrl.length;
            e.preventDefault();
        ...
        _end: function(e) {
            if ((e.type === "mouseup" || e.type === "mousecancle")) { this.el.removeEventListener("mousemove", this, false);
                this.el.removeEventListener("mousecancle", this, false) }
            if (this.moveStatu) {
            ...
            if (this.options.auto) {
                ...
                this.time = setInterval(function() {
                    _this.index++;
                    if (_this.index > l) { _this.index = _this.index - l; }
